...
class nusoap_xmlschema extends nusoap_base {
   ...
   * assoc. arrays returns false if no type exists, or not w/ the given
   * namespace else returns a string that is either a native php type, or
   * 'struct'
   *
...
class soapval extends nusoap_base {
   ...
   * @param mixed $attributes associative array of attributes to add to element
   *   serialization
   *
   * @access   public
   */
...
class soap_transport_http extends nusoap_base {
   ...
   *   (optional), verifyhost (optional): see corresponding options in cURL
   *   docs)
   *
   * @access   public
   */
...
class nusoap_server extends nusoap_base {
   ...
   * @param mixed $style optional (rpc|document) or false Note: when 'document'
   *   is specified, parameter and return wrappers are created for you
   *   automatically
...
class wsdl extends nusoap_base {
   ...
   * @param string $bindingType eg: soap, smtp, dime (only soap and soap12 are
   *   currently supported)
   *
   * @return array
   * @access public
   ...
   * @param boolean $unqualified a kludge for what should be XML namespace form
   *   handling
   *
   ...
   *   Note: when 'document' is specified, parameter and return wrappers are
...
class nusoap_client extends nusoap_base {
   ...
   * constructor
   *
   * @param mixed $endpoint SOAP server or WSDL URL (string), or wsdl instance
   *   (object)
   ...
   * @param string $style optional (rpc|document) the style to use when
   *   serializing parameters (WSDL can override)
   * @param string $use optional (encoded|literal) the use when serializing
   *   parameters (WSDL can override)
   *
   * @return  mixed  response from SOAP call, normally an associative array
   *   mirroring the structure of the XML response, false for certain fatal
   *   errors
   * @access   public
   */
   ...
   *
   * @param string $endpoint The endpoint URL to use, or empty string or false
   *   to prevent override
   *
   * @access   public
   */
   ...
   *
   * @param mixed $headers String of XML with SOAP header content, or array of
   *   soapval objects for SOAP headers
   *
   * @access   public
   */
